              ...
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="m-0 animated fadeInUp p-0">
                    ...
                    <a onClick={updateStatus.bind(this, item._id) } className="icon-nav text-primary mx-1">
                      <AiOutlineEdit />
                    </a>
                    <a onClick={deleteItem.bind(this, item._id, item.status) } className="icon-nav text-danger mx-1">
                      <AiOutlineDelete />
                    </a>
